...
public class EventController {
	...
	@RequestMapping(value = "/", method = RequestMethod.POST, consumes = applicationJson, produces = applicationJson)
	public Event createEvent(@RequestBody Event event) {
		return eventService.createEvent(event);
	}
	
	@ApiOperation(value = "Find an event by ID")
	@RequestMapping(value = "/{id}", method = RequestMethod.GET, produces = applicationJson)
	...
	@RequestMapping(value = "/", method = RequestMethod.GET, produces = applicationJson)
	public List<Event> findAllEvents() {
		return eventService.findAllEvents();
	}
	
	@ApiOperation(value = "Delete events")
	@RequestMapping(value = "/delete", method = RequestMethod.POST, consumes = applicationJson)
	public void deleteEvents(@RequestBody List<Event> events) {
		eventService.deleteEvents(events);
	}
	
	@ApiOperation(value = "Update events")
	@RequestMapping(value = "/update", method = RequestMethod.POST, consumes = applicationJson, produces = applicationJson)
